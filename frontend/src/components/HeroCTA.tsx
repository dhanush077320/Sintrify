...
export default function HeroCTA({ onExplore, onStartProject }: HeroCTAProps) {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.stats}>
          <div className={styles.statItem}>
            <span className={styles.count}><CountUp end={stats.happyClients} duration={400} />+</span>
            <span className={styles.label}>Happy Clients</span>
          </div>
          <div className={styles.statItem}>
            <span className={styles.count}><CountUp end={stats.projectsDelivered} duration={400} />+</span>
